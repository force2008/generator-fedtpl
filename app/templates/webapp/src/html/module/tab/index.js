...
function(){
    ...
    _p._$$ModuleSystemTab = NEJ.C();
      _proModuleSystemTab = _p._$$ModuleSystemTab._$extend(_m._$$Module);
    /**
     * 构建模块
     * @return {Void}
     */
    _proModuleSystemTab.__doBuild = function(){
        this.__supDoBuild();
     ...
     * @return {Void}
     */
    _proModuleSystemTab.__onRefresh = function(_options){
     ...
     * @return {Void}
     */
    _proModuleSystemTab.__doCheckMatchEQ = function(_event){
